...
class _OnboardingFlowState extends State<OnboardingFlow> {
  ...
  Future<void> chooseInstrument() async {
    final selected = await showInstrumentPicker(context, selected: instrument);
    if (selected != null) setState(() => instrument = selected);
  }
  @override
        ...
        body: SafeArea(
          child: Padding(
            ...
            child: Column(children: [
              ...
              const Spacer(),
              Expanded(flex: 6, child: PageView(controller: controller, onPageChanged: (value) => setState(() => page = value), children: [const _Welcome(), _ProfileSetup(name: name, instrument: instrument, onInstrumentTap: chooseInstrument)])),
              Row(children: [
